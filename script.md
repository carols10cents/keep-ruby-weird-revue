...
So now we're going to use something called scaffold. Scaffold is a quick way of putting your model object online in a way that you can edit it--Whoops! we need to restart the server when we change the database configuration. so, let's just do that. Um, as I was saying, scaffolding is a way of easily putting a model object online in a way that you can edit it. Whoops! We didn't create this, this was created for us just by the scaffolding thing. Now we're going to create a new post, just... "hello brazil". Yaaay! Post was successfully created.
